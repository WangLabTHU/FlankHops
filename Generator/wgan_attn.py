...
def main():
    ...
    n_critics = 5
    n_iters = 10000
    model = WGAN(input_nc=4, output_nc=4, seqL=seqL, l1_w=30)
    ...
    for i in range(n_iters):
        ...
        if i % 100 == 99:
            ...
            torch.save(model.generator, 'check_points/' + data_name + 'net_G_' + str(i) + '.pth')
            torch.save(model.discriminator, 'check_points/' + data_name + 'net_D_' + str(i) + '.pth')
